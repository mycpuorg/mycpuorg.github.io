...
excerpt: "Zsh"
tags: [Emacs, Linux, Code, IDE, source code navigation, zsh]
comments: true
---
I use bash, I see too many smart people use zsh. So I decided to switch to it,
but decided to spice it up by using ``oh-my-zsh``.

## Power Level 9k - a ``zsh`` theme
```
# Path to your oh-my-zsh installation.
export ZSH=/home/manoj/.oh-my-zsh

# Path to your powerlevel9k installation
...
## CheatSheet
Below I am shamelessly
copying the [cheatsheet](https://github.com/ohmyzsh/ohmyzsh/wiki/Cheatsheet)
from their wiki. If you are here I will 
